...
num_part_asd <- 500
asd.sensitivity <- rnorm(num_part_asd, mean = 2, sd = 0.5) #sample(seq(from = 1, to = 6, by = inc), size = num_part, replace = TRUE)
asd.narrowing <- rnorm(num_part_asd, mean = 1, sd = 0.5)# sample(seq(from = 1, to = 6, by = inc), size = num_part, replace = TRUE)
asd.plasticity <- rnorm(num_part_asd, mean = 4, sd = 0.5) #sample(seq(from = 5, to = 9, by = inc), size = num_part, replace = TRUE)
asd.age <- sample(seq(from = 1, to = 38, by = inc), size = num_part_asd, replace = TRUE)
asd.category <- rep("asd",num_part_asd)
...
with(all.data, scatter3D(x = sensitivity, y = narrowing, z = plasticity, colvar = age, 
                         ...
                         zlab = "Plasticity",
                         main = "Sample data",  
                        theta = 70,  phi=20, d = 5, col = ramp.col(col = c("lightblue", "blue2","chocolate2"), 90),#type = "h", 
